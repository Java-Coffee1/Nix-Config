...

{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-fb37e8b1-50c1-4a82-ab76-b7c6c2b683d3 = [ ];
      "KDE Keyboard Layout Switcher"."Switch to Last-Used Keyboard Layout" = "Meta+Alt+L";
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "Meta+Alt+K";
      kaccess."Toggle Screen Reader On and Off" = "Meta+Alt+S";
      kactivitymanagerd."Show Activity Switcher" = [ ];
      kactivitymanagerd."Switch to Next Activity" = [ ];
      kactivitymanagerd."Switch to Previous Activity" = [ ];
      ...
      "services/plasma-manager-commands.desktop".launch-konsole = "Meta+Q";
    };
    configFile = {
      baloofilerc."Basic Settings".Indexing-Enabled = false;
      baloofilerc.General.dbVersion = 2;
      dolphinrc.General.ViewPropsTimestamp = "2026,8,18,15,23,36.495";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities.fb37e8b1-50c1-4a82-ab76-b7c6c2b683d3 = "Default";
      ...
      kwinrc.Desktops.Id_1 = "9b8ce155-0dab-48b6-9484-e692dbdfecf4";
      kwinrc.Desktops.Name_1 = "Desktop 5";
      ...
      spectaclerc.ViewerWindow."2 screens: Height" = 570;
      spectaclerc.ViewerWindow."2 screens: Width" = 774;
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/javi/Downloads/system-packages.nix";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 931;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,931,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 1870;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0".ScrollLine = 60;
